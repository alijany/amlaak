...
export const brand = {
  ...
  landing: {
    ...
    forAgencies: {
      ...
      body: 'آگهی‌های خود را رایگان ثبت کنید، روی وب‌سایت و کانال تلگرام منتشر کنید و سرنخ‌های فروش را در پنل مدیریت کنید.',
      bullets: [
        'انتشار خودکار روی وب و تلگرام',
        'مدیریت سرنخ و پیگیری تا معامله',
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'خیر. مشاهده و جستجوی آگهی‌ها برای همه آزاد است. برای ثبت آگهی یا مدیریت سرنخ‌ها کافی است با شماره موبایل وارد شوید.',
        },
        {
