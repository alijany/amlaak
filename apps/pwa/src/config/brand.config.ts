...
export const brand = {
  ...
  // ── Contact ───────────────────────────────────────────────────────────────
  contact: {
    phone: { primary: '+989910401049', display: '0991 040 1049' },
    address: 'رشت، گلسار، خیابان نواب، مجتمع نوا',
  },

  // ── SEO / Metadata ────────────────────────────────────────────────────────
  meta: {
    title: 'نوا ملک | جستجوی خرید، فروش و اجاره ملک',
    description:
      'هزاران آگهی ملک از معتبرترین منابع را یکجا جستجو کنید؛ سریع، به‌روز و قابل اعتماد. خرید، فروش و اجاره ملک با نوا ملک.',
  },

  // ── Footer ────────────────────────────────────────────────────────────────
  description:
    'نوا ملک آگهی‌های خرید، فروش و اجاره ملک را از منابع مختلف گردآوری و در یک پلتفرم یکپارچه منتشر می‌کند. مشاوران املاک نیز می‌توانند آگهی ثبت کنند و مشتری‌های فروش را مدیریت کنند.',
  copyright: '© 1404 نوا ملک. کلیه حقوق محفوظ است.',
