...
export const CATEGORY_LABEL: Record<RealEstateCategory, string> = {
...
/**
 * The public visitor view of a listing. Shared by the public detail page
 * (`/listings/[id]`) and the agency dashboard "public preview" so an agent
 * sees exactly how customers will see the ad.
 */
